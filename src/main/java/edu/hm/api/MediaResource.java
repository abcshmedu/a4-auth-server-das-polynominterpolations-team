...
/** Dies ist unsere Implementierung der REST-API für den Auth-Server der
 * ShareIT-Anwendung.
 * 
...
public class MediaResource {
     ...
     * 
     * @param user
     *            Der neu zu erstellende User
     * @return Ein Response-Objekt, welches den Status und Details der
     *         ausgeführten Anfrage enthält */
    @POST
    @Path("user")
    ...
    /** Diese Methode verifiziert ein Token, welches der User bekommt, nachdem
